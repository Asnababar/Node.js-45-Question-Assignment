...
// create an array to store Travel Desinations.

let travelDestinations: string[] = ["Maldives", "Switzerland", "Amazon rainforest", "Pyramid Giza"]
...
console.log("\nChange to Reverse Alphabetival Order")
