...
const favouriteFruits: string[] = ["Banana", "apple", "Mango"];
...
if (favouriteFruits.includes("Orange")){
    ...
    console.log("Orange are not is your favourite fruit list.")
}
...
if (favouriteFruits.includes("Grapes")){
    ...
    console.log("Grapes are not is your favourite fruit list.")
}
